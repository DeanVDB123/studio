...
const memorialFormSchema = z.object({
  ...
  templateId: z.enum(['classic', 'modern', 'skyline']).optional().default('classic'),
}).refine(
  (data) => {
          ...
          <Controller
              ...
              render={({ field }) => (
                  ...
                  >
                      ...
                      <Label htmlFor="template-skyline" className="border rounded-md p-4 has-[input:checked]:bg-primary has-[input:checked]:text-primary-foreground has-[input:checked]:border-primary transition-colors cursor-pointer">
                          <div className="flex items-center gap-4">
                              <RadioGroupItem value="skyline" id="template-skyline" />
                              <div className="flex-grow">
                                  <div className="flex items-center gap-2 font-headline text-lg">
                                      <Mountain className="h-5 w-5" />
                                      Skyline
                                  </div>
                                  <p className="text-sm font-normal mt-1">A dramatic, full-width design with a floating content card.</p>
                              </div>
                          </div>
                      </Label>
                  </RadioGroup>
